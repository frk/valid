...
func TestAnalysisRun(t *testing.T) {
	...
	file_analysis := "github.com/frk/isvalid/internal/testdata/analysis.go"
				...
				Type: Type{
					...
					Elem: &Type{
						...
						Fields: []*StructField{{
							...
							Tag:   tagutil.Tag{"is": []string{`:@create`}},
							Rules: []*Rule{{Name: "isvalid", Context: "create"}},
						}, {
							Name: "f79", Key: "f79",
							Type: Type{
								Kind: TypeKindPtr,
