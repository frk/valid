...
func TestAnalyze(t *testing.T) {
	...
	p1 := Pkg{
		Path: "github.com/frk/valid/cmd/internal/types/testdata/mypkg",
		Name: "mypkg",
	}
	...
	tests := []struct {
		...
		want: &Type{Pkg: p0, Name: "Str2BoolMap", Kind: MAP, IsExported: true,
			Key:  &Obj{Type: &Type{Pkg: p0, Name: "StringType", Kind: STRING, IsExported: true}},
			Elem: &Obj{Type: T.bool}},
	}, {
		ty: test_type("str2BoolMap"),
		want: &Type{Pkg: p0, Name: "str2BoolMap", Kind: MAP,
			Key:  &Obj{Type: T.string},
			Elem: &Obj{Type: &Type{Pkg: p0, Name: "BoolType", Kind: BOOL, IsExported: true}}},
	}, {
		ty: test_type("StrPointer"),
		want: &Type{Pkg: p0, Name: "StrPointer", Kind: PTR, IsExported: true,
			Elem: &Obj{Type: &Type{Pkg: p0, Name: "StringType", Kind: STRING, IsExported: true}}},
	}, {
		ty: test_type("strPointer"),
		...
		want: &Type{Pkg: p0, Name: "StructType", Kind: STRUCT, IsExported: true,
			Fields: []*StructField{
				{Pkg: p0, Name: "F1", Obj: &Obj{Type: T.string}, Tag: `is:"some_rule"`, IsExported: true},
				{Pkg: p0, Name: "f2", Obj: &Obj{Type: T.bool}, Tag: `foo bar baz`, IsExported: false},
			}},
	}, {
		ty: test_type("structType"),
		want: &Type{Pkg: p0, Name: "structType", Kind: STRUCT,
			Fields: []*StructField{
				{Pkg: p0, Name: "f1", Obj: &Obj{Type: &Type{
					Pkg:        p1,
					Name:       "ConstType1",
					Kind:       UINT,
					IsExported: true,
				}}, Tag: `is:"some_rule"`},
				{Pkg: p0, Name: "f2", Obj: &Obj{Type: &Type{
					Pkg:        p1,
					Name:       "Struct",
					Kind:       STRUCT,
					IsExported: true,
		...
		want: func() *Type {
			...
			t.Fields = []*StructField{{Pkg: p0, Name: "F1",
				Obj:        &Obj{Type: &Type{Kind: PTR, Elem: &Obj{Type: t}}},
				IsExported: true}}
			return t
		}(),
	}, {
		...
		want: &Type{Pkg: p0, Name: "genMap1", Kind: MAP,
			Key:  &Obj{Type: &Type{Kind: INTERFACE, Name: "comparable"}},
			Elem: &Obj{Type: &Type{Kind: INTERFACE}},
		...
		want: &Type{Pkg: p0, Name: "genMap2", Kind: MAP,
			Key: &Obj{Type: &Type{Kind: INTERFACE, Embeddeds: []*Type{
