...
func methodAST(g *gg, info *rules.Info) (dec GO.MethodDecl) {
	...
	if xtypes.Globals.ErrorAggregator != nil && info.Validator.ErrorHandlerField == nil {
...
func exitAST(info *rules.Info, b bb) {
	...
	hasAgg := false
	if (errh != nil && errh.IsAggregator) || (errh == nil && xtypes.Globals.ErrorAggregator != nil) {
		hasAgg = true
	}
	...
	case hasAgg == true && after != nil:
		...
		} else if h == nil && xtypes.Globals.ErrorAggregator != nil {
...
func newErrorAggregatorAST(info *rules.Info, b bb) {
	agg := xtypes.Globals.ErrorAggregator
