...
type Error struct {
	...
	r2 *rules.Rule
	// The spec of the rule with which the error is related, or nil.
	rs *spec.Spec
...
func (e *Error) RuleSpecArgMin() string {
	return strconv.Itoa(e.rs.ArgMin)
}

func (e *Error) RuleSpecArgMax() string {
	return strconv.Itoa(e.rs.ArgMax)
}

func (e *Error) RuleSpecKind() string {
	return e.rs.Kind.String()
}

func (e *Error) RuleFuncIdent() string {
	return e.rs.FType.Pkg.Name + "." + e.rs.FName
}

func (e *Error) RuleFuncType() string {
	return e.rs.FType.TypeString(nil)
}

func (e *Error) RuleFuncNameWithType() string {
	t := e.rs.FType.TypeString(nil)
	return e.rs.FName + strings.TrimPrefix(t, "func")
}

func (e *Error) RuleFuncIn0Type() string {
	return e.rs.FType.In[0].Type.TypeString(nil)
}

func (e *Error) RuleFuncOut0Type() string {
	return e.rs.FType.Out[0].Type.TypeString(nil)
}

func (e *Error) RuleFuncParamType() string {
	if e.rs.FType.IsVariadic && len(e.rs.FType.In) < *e.fpi {
